...
protocol StorageService {
    ...
    func savePermissions(_ permission: AppModel.PermissionModel)
    func markLaunched()
    func loadState() -> StoredModel
}

final class UserDefaultsStorageService: StorageService {
    private let store = UserDefaults(suiteName: "group.birdcargo.storage")!
    private let cache = UserDefaults.standard
    
    private enum Key {
        static let tracking = "bcf_tracking_payload"
        static let navigation = "bcf_navigation_payload"
        static let endpoint = "bcf_endpoint_target"
        static let mode = "bcf_mode_active"
        static let firstLaunch = "bcf_first_launch_flag"
        static let permGranted = "bcf_perm_granted"
        static let permDenied = "bcf_perm_denied"
        static let permDate = "bcf_perm_date"
    }
    ...
    func loadState() -> StoredModel {
        ...
        return StoredModel(
            ...
            permission: StoredModel.PermissionData(
                isGranted: granted,
                isDenied: denied,
                lastAsked: date
            )
